#!/usr/bin/env python3
"""
_robot6x.py  --  Shared robot module for the DUAL-ARM Lagrangian pipeline
===============================================================================
Reconstructed counterpart of _robot4x, scoped to 6 arms (dsr01..dsr06).
...
ARM_NAMES = ['dsr01', 'dsr02', 'dsr03', 'dsr04', 'dsr05', 'dsr06']
ROBOT_BASES = {
...
if USE_MESH:
    try:
        ...
        if _mc.available():
            ...
            print("[_robot6x] REAL-MESH collision active (FCL)")
        else:
            print("[_robot6x] mesh_collision unavailable -> capsule model")
    except Exception as _e:
        print("[_robot6x] mesh import failed (%s) -> capsule model" % _e)