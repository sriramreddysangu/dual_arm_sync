#!/usr/bin/env python3
"""
_robot4x.py  --  Shared robot module for the DUAL-ARM Lagrangian pipeline
===============================================================================
Reconstructed counterpart of _robot4x, scoped to 4 arms (dsr01..dsr04).
...
if USE_MESH:
    try:
        ...
        if _mc.available():
            ...
            print("[_robot4x] REAL-MESH collision active (FCL)")
        else:
            print("[_robot4x] mesh_collision unavailable -> capsule model")
    except Exception as _e:
        print("[_robot4x] mesh import failed (%s) -> capsule model" % _e)